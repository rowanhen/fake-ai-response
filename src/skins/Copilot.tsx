              ...
              <div className="flex gap-3">
                <div className="flex-shrink-0 w-7 h-7 rounded-full bg-gradient-to-br from-[#7c3aed] to-[#a855f7] flex items-center justify-center">
                  <svg className="w-4 h-4 text-white" viewBox="0 0 16 16" fill="currentColor">
                    <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM4.756 4.21c-.076 0-.19.034-.296.139-.106.104-.195.287-.195.59 0 .282.08.479.184.596.063.071.121.103.157.113a.37.37 0 0 0 .093.013c.078 0 .205-.038.32-.152.114-.114.195-.3.195-.57 0-.268-.08-.453-.194-.566-.115-.113-.244-.163-.264-.163ZM8 2.5a5.5 5.5 0 0 0-4.613 8.508L4.756 9.65c-.612 0-1.124-.22-1.492-.577C2.896 8.716 2.69 8.2 2.69 7.654c0-.568.196-1.077.59-1.46.396-.386.933-.598 1.57-.598.635 0 1.16.216 1.543.598.38.377.587.87.587 1.46 0 .57-.196 1.079-.575 1.46a2.11 2.11 0 0 1-1.142.575l1.056 1.582A5.5 5.5 0 1 0 8 2.5Z"/>
                  </svg>
                </div>
                <div className="flex-1 pt-1">
                  <div className={`text-xs mb-1 font-medium ${darkMode ? 'text-[#a855f7]' : 'text-[#7c3aed]'}`}>Copilot</div>
                  <div className={`whitespace-pre-wrap leading-relaxed ${darkMode ? 'bg-[#0d1117]' : 'bg-[#f6f8fa]'} rounded-lg p-3 border ${border}`}>
                    {message.content}
                  </div>
                </div>
              </div>
